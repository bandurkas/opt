...
> **Последнее обновление:** 2026-06-16 · HEAD `main` `538b616` · local = GitHub = VPS, дерево чистое.
> ⚠️ В paper задеплоено до `a436302`. Гейдж 2.1 (`0a8d72b`) — код готов, НЕ задеплоен (нужен rebuild backend+frontend).
