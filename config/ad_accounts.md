...
## Аккаунт 1: GDI Future

- **Account ID**: act_2043250756570558
- **Page ID**: 941164055757971
- **Instagram ID**: 46660321512
- **Название**: GDI Future Works
- **Сайт**: https://gdifuture.works/
- **Бриф**: [briefs/gdifuture.md](briefs/gdifuture.md)
- **Статус**: активен
- **Валюта**: IDR
- **Часовой пояс**: UTC+7 (Jakarta)
- **Тип конверсии**: Lead-формы | WhatsApp
- **Заметки**: EdTech / IT-курсы, рынок Индонезия. Целевой CPL: IDR 30k–120k.
