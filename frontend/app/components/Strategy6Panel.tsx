...
export default function Strategy6Panel(){
  ...
  return <section id="strategy6" className="rounded-xl border border-slate-800 bg-slate-900/60 overflow-hidden">
    <div className="p-4 border-b border-slate-800 flex flex-wrap justify-between gap-2">
      <div><h2 className="font-bold text-cyan-300 text-lg">Стратегия №6 v2 · A · исходная</h2><p className="text-xs text-slate-400">Дневной FVG → слом → откат 50–60% · 15m / 30m</p></div>
    ...
    <div className="p-4 space-y-4">
      <div className="rounded-lg border border-slate-700 p-3 text-sm text-slate-300 space-y-2">
        <p className="text-xs text-slate-400">Только исходный вариант A: один вход и полный выход, без E2, усреднения и трейлинга. Стоп, тейк и объём прежние; комиссии 0,05% и проскальзывание 0,02% за исполнение. Funding учитывается по доступной истории. Симуляция, не реальная торговля.</p>
      </div>
